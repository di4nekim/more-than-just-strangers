// Mock AWS SDK v3 before importing anything else
...
describe('endConversation Lambda Integration Tests', () => {
    ...
    describe('Success Cases', () => {
        test('should successfully end conversation and notify other user', async () => {
            ...
            mockDynamoGet
                .mockReturnValueOnce(Promise.resolve({ Item: mockConversation }))
                .mockReturnValueOnce(Promise.resolve({ Item: mockUserMetadata }));

            // Mock DynamoDB update
            mockDynamoUpdate.mockReturnValue(Promise.resolve({}));

            // Mock API Gateway postToConnection
            mockApiGatewayPost.mockReturnValue(Promise.resolve({}));
        ...
        test('should handle notification failure gracefully', async () => {
            ...
            mockApiGatewayPost.mockReturnValue(Promise.reject(error));
    ...
    describe('Error Cases', () => {
        ...
        test('should return 404 when conversation not found', async () => {
            ...
            mockDynamoGet.mockReturnValue(Promise.resolve({ Item: null }));
        ...
        test('should return 500 when DynamoDB get fails', async () => {
            ...
            mockDynamoGet.mockReturnValue(Promise.reject(new Error('DynamoDB connection failed')));
    ...
    describe('Edge Cases', () => {
        test('should handle conversation with single participant', async () => {
            ...
            mockDynamoGet.mockReturnValue(Promise.resolve({ Item: mockConversation }));
        ...
        test('should handle other user metadata not found', async () => {
            ...
            mockDynamoGet
                .mockReturnValueOnce(Promise.resolve({ Item: mockConversation }))
                .mockReturnValueOnce(Promise.resolve({ Item: null })); // User metadata not found
